...
public static abstract class Stub extends android.os.Binder implements com.vink.music.util.IMediaPlaybackService
{
private static final java.lang.String DESCRIPTOR = "com.vink.music.util.IMediaPlaybackService";
...
/**
 * Cast an IBinder object into an com.vink.music.util.IMediaPlaybackService interface,
 * generating a proxy if needed.
 */
public static com.vink.music.util.IMediaPlaybackService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.vink.music.util.IMediaPlaybackService))) {
return ((com.vink.music.util.IMediaPlaybackService)iin);
}
return new com.vink.music.util.IMediaPlaybackService.Stub.Proxy(obj);
}
...
private static class Proxy implements com.vink.music.util.IMediaPlaybackService
{
